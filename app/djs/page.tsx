...
const djs = [
  {
    ...
    bio: "Known for 3am sets that stretch the limits of tempo and tonality, Mortl drifts from sacred stillness to explosive chaos. Expect high-concept sound design, psychoacoustic illusions, and journeys that question what music even is.",
    hasFullProfile: true,
  },
  {
    id: "madmanski",
